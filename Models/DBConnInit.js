...
conn.query("CREATE TABLE SHARING (ID VARCHAR(50)  NOT NULL , POSTER VARCHAR(50) NOT NULL, FILE_LOCATION VARCHAR(400) NULL ,FILE_NAME VARCHAR(100) NULL ,CREATION_DATE DATETIME NULL DEFAULT current_timestamp() , EXPIRE_DATE DATETIME NULL , STATUS CHAR(1) NULL DEFAULT '0', FILE_SIZE VARCHAR(10)NULL , POSTER_IP VARCHAR(20) NULL  , ISCONFIRMED CHAR(1) NULL DEFAULT '0', CONFIRMATION_ID VARCHAR(100) NULL, PRIMARY KEY (ID) ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8");

conn.query("CREATE TABLE MAIL_TO (ID VARCHAR(50) NOT NULL ,EMAIL_POSTER VARCHAR(50) NULL , EMAIL_RECEIVER VARCHAR(600) NULL , EMAIL_SUBJECT VARCHAR(100) NULL , EMAIL_CONTENT TEXT NULL , EMAIL_STATUS VARCHAR(1) NULL DEFAULT 0, EMAIL_SENDCOUNT INT(4) NULL DEFAULT 0, EMAIL_CREATETIME DATETIME NULL DEFAULT current_timestamp() , EMAIL_SENDTIME DATETIME NULL , SHARING_ID VARCHAR(50)NULL, ISCONFIRMED CHAR(1)NULL DEFAULT '0' ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8");
